...
const {registerForm, errors} = storeToRefs(store)
...
<template>
    <div class="form-signin w-100 m-auto">
        ...
        <div class="form-floating">
            <input type="text" class="form-control" required id="name" v-model="registerForm.name" placeholder="Name">
        ...
        <button type="button" class="btn btn-primary w-100 my-2" @click="store.register">Register</button>
